...
export default function UserAdminPrintingReport(p) {
    ...
    return (
        ...
        <div>
            <AdminNavBarGoGo />
            <Link to={"/user-admin-dashboard"} className="backLink"><FontAwesomeIcon icon={faArrowAltCircleLeft} /> Go Back</Link>
